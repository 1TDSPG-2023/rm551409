    ...
    if(evt.target.id == "btnSubmit"){
        ...
        try {
            ...
            if(msg == "VALIDADO"){
                ...
                const token = Math.random().toString(16).substring(2) + Math.random().toString(16).substring(2); //substring RETORNA A STRING A PARTIR DA POSIÇÃO QUE DEFINIRMOS

                //ADICIONADO O TOKEN NO LOCAL-STORAGE
